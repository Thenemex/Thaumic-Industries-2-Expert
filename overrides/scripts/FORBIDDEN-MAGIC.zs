...
game.setLocalization("fr_FR", "tc.research_text.VANILLABED", "La solution à vos cauchemars");
...
game.setLocalization("fr_FR", "tnmx.artifice.vanillabed_1", "Après avoir passé un nombre de nuits horribles incalculable, caché dans les arbres ou dans les grottes en attendant que le soleil purificateur se leve et brule les abonimations de l'ombre ; vous relechissiez depuis un moment a pouvoir dormir en paix.<LINE>En alliant des morceaux de soie cramoisie et enchantee avec des cristaux de paresse ; vous avez construit un lit magique d'un temps oublié qui permet au joueur de passer la nuit directement a l'aube !");
// Adding the craft
