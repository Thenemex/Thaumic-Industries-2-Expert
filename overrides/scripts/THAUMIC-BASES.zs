...
val en_nerfedText = "<LINE>The aspects of this item have been §c§ldeactivated§r§0, because we can't find a proper way to balance it.<BR>It is still functionnal and present for a decorative purpose.<LINE>";
val fr_nerfedText = "<LINE>Les aspects de cet objet ont été §c§ldésactivés§r§0, en raison de l'impossibilité de l'équilibrer correctement.<BR>Il reste fonctionnel et présent pour un usage décoratif.<LINE>";
