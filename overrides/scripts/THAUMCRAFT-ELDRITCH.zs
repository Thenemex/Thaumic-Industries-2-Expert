...
val fr_text1 = "En infusant de la magie dans du métal vous avez réussi a créer du Thaumium. C'était une découverte de valeur, mais le temps est venu de laisser le thaumium aux amateurs et à ceux qui n'osent pas se mouiller.<BR>Un rêve fou et à moitié oublié vous a donné le besoin d'essayer quelque chose de... Différent. Que se passerait il si au lieu d'infuser du métal avec juste de la magie, vous l'infusiez avec l'essence même de la source de la magie: Les Ténèbres et le vide qui demeure entre les étoiles.<BR>Le metal qui en résulte est lisse et chaud au toucher... De façon troublante.";
val fr_text3 = "Il est presque aussi souple que l'or le rendant facile à travailler, mais quand il est frappé il devient aussi dur que du thaumium et parfois même plus dur. Encore plus impressionant tous les dommages sauf les plus dévastateurs se réparent d'eux mêmes, le métal reprenant lentement sa forme d'origine.<BR> Le seul point négatif est qu'il est plus difficile à enchanter que du thaumium, mais toujours meilleur que des matériaux basiques comme du fer.<BR>Vous avez découvert que la prudence est de mise quand on manipule ce métal ; votre force semble temporairement disparaître lorsque vous être blessé par celui-ci.";
